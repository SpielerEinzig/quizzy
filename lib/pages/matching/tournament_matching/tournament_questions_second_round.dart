...
import 'tournament_result_round_two.dart';

class TournamentQuestionsSecondRound extends StatefulWidget {
  final String gameId;
  final int questionId;
  const TournamentQuestionsSecondRound(
      {Key? key, required this.gameId, required this.questionId})
      : super(key: key);

  @override
  State<TournamentQuestionsSecondRound> createState() =>
      _TournamentQuestionsSecondRoundState();
}

class _TournamentQuestionsSecondRoundState
    extends State<TournamentQuestionsSecondRound> {
    ...
    setState(() {
      currentQuestion >= questionList.length - 1
          ? Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => TournamentResultRoundTwo(
