...
import 'package:quizzy/pages/matching/tournament_matching/tournament_result_round_one.dart';
...
class TournamentQuestions extends StatefulWidget {
  final String gameId;
  ...
  @override
  State<TournamentQuestions> createState() => _TournamentQuestionsState();
}

class _TournamentQuestionsState extends State<TournamentQuestions> {
    ...
    setState(() {
      currentQuestion >= questionList.length - 1
          ? Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => TournamentResultRoundOne(
